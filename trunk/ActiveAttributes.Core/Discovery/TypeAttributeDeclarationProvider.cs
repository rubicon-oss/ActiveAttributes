...
{
  public class TypeAttributeDeclarationProvider : ITypeLevelDeclarationProvider
  {
    private readonly IAttributeDeclarationProvider _attributeDeclarationProvider;

    public TypeAttributeDeclarationProvider (IAttributeDeclarationProvider attributeDeclarationProvider)
    {
