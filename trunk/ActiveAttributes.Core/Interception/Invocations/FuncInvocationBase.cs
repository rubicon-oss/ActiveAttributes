...
{
  public abstract class FuncInvocationBase<TInstance, TReturn> : ArgumentCollectionBase, IInvocation
  {
    ...
    protected FuncInvocationBase (MemberInfo memberInfo, TInstance instance)
    {
