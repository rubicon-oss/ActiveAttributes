...
{
  public class ParameterAttributedAspectDeclarationProvider : IMethodLevelAspectDeclarationProvider
  {
    private readonly IAspectDeclarationHelper _aspectDeclarationHelper;

    public ParameterAttributedAspectDeclarationProvider (IAspectDeclarationHelper aspectDeclarationHelper)
    {
