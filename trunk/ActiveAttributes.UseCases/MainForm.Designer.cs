namespace ActiveAttributes.UseCases
{
  partial class MainForm
  {
    ...
    private void InitializeComponent ()
    {
      ...
      this.button1.Text = "Add line w/o invoke";
      ...
      this.button2.Text = "Add line w/ invoke";
      ...
      this.button3.Text = "Get cached time by 5s steps";
      this.button3.UseVisualStyleBackColor = true;
      this.button3.Click += new System.EventHandler(this.button3_Click);
      // 
      // button4
      // 
      this.button4.Location = new System.Drawing.Point(26, 115);
      this.button4.Name = "button4";
      this.button4.Size = new System.Drawing.Size(161, 23);
      this.button4.TabIndex = 4;
      this.button4.Text = "Update form title";
