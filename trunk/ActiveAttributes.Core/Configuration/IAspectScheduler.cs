...
namespace ActiveAttributes.Core.Configuration
{
  ...
  {
    IEnumerable<AspectAttribute> GetSchedule (IEnumerable<AspectAttribute> aspects);
  }
  ...
  public class AspectScheduler : IAspectScheduler
  {
    ...
    public IEnumerable<AspectAttribute> GetSchedule (IEnumerable<AspectAttribute> aspects)
    {
      return null;
    }
  }
