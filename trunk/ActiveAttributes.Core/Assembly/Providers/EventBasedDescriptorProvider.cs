...
{
  public class EventBasedDescriptorProvider : IMethodLevelDescriptorProvider
  {
    private readonly RelatedEventFinder _eventFinder;

    public EventBasedDescriptorProvider ()
    {
    ...
    public IEnumerable<IDescriptor> GetDescriptors (MethodInfo method)
    {
      ...
      return DescriptorProvider.GetDescriptors (event_, eventSequence);
    }
  }
}