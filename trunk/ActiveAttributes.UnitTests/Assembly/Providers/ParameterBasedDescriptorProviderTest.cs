...
namespace ActiveAttributes.UnitTests.Assembly.Providers
{
  ...
  {
    private ParameterBasedDescriptorProvider _provider;

    [SetUp]
    public void SetUp ()
    {
      _provider = new ParameterBasedDescriptorProvider();
    }
    ...
    public void Normal ()
    {
      ...
      Assert.That (result, Has.All.Matches<IDescriptor> (x => x.AspectType == typeof (AppliedAspectAttribute)));
    }
