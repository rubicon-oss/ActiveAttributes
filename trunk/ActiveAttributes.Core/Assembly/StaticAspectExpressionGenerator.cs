...
{
  public class StaticAspectExpressionGenerator : AspectExpressionGeneratorBase
  {
    public StaticAspectExpressionGenerator (FieldInfo fieldInfo, int index, IAspectAttributeDescriptor descriptor)
