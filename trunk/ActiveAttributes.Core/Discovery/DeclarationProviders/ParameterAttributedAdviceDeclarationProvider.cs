...
{
  public class ParameterAttributedAdviceDeclarationProvider : IMethodLevelAdviceDeclarationProvider
  {
    private readonly IAttributeDeclarationProvider _attributeDeclarationProvider;

    public ParameterAttributedAdviceDeclarationProvider (IAttributeDeclarationProvider attributeDeclarationProvider)
    {
