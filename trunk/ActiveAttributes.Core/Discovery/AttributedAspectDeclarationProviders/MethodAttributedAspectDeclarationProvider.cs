...
{
  public class MethodAttributedAspectDeclarationProvider : IMethodLevelAspectDeclarationProvider
  {
    private readonly IAspectDeclarationHelper _aspectDeclarationHelper;
    private readonly IRelatedMethodFinder _relatedMethodFinder;

    public MethodAttributedAspectDeclarationProvider (IAspectDeclarationHelper aspectDeclarationHelper, IRelatedMethodFinder relatedMethodFinder)
    {
    ...
    public IEnumerable<AspectDeclaration> GetDeclarations (MethodInfo method)
    {
      ...
      return methodSequence.SelectMany (x => _aspectDeclarationHelper.GetAspectDeclarations (x));
    }
  }
}