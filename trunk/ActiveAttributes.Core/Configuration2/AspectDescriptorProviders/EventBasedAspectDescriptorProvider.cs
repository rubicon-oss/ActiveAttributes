...
{
  public class EventBasedAspectDescriptorProvider : IMethodLevelAspectDescriptorProvider
  {
    ...
    public IEnumerable<IAspectDescriptor> GetDescriptors (MethodInfo method)
    {
      ...
      return AspectDescriptorProviderUtility.GetDescriptors (event_, eventSequence);
    }
  }
}