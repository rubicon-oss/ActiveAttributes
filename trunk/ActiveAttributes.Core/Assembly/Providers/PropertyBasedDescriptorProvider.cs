...
{
  public class PropertyBasedDescriptorProvider : IMethodLevelDescriptorProvider
  {
    private readonly RelatedPropertyFinder _propertyFinder;

    public PropertyBasedDescriptorProvider ()
    {
      _propertyFinder = new RelatedPropertyFinder(); // TODO inject
    }

    public IEnumerable<IDescriptor> GetDescriptors (MethodInfo method)
    {
      ...
      return DescriptorProvider.GetDescriptors (property, propertySequence);
    }
  }
}