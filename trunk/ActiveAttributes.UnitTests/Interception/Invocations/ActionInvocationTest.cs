...
namespace ActiveAttributes.UnitTests.Interception.Invocations
{
  ...
  public class ActionInvocationTest
  {
    ...
    public void Initialization ()
    {
      ...
      var invocation = new ActionInvocation<DomainType, string> (method, instance, "arg", instance.Method);
    ...
    public void Proceed ()
    {
      ...
      invocation.Arg1 = "7";
      invocation.Proceed ();
      Assert.That (DomainType.Argument, Is.EqualTo ("7"));
    }

    class DomainType
    {
      public static string Argument { get; private set; }

      public void Method (string arg) { Argument = arg; }
    }
  }
}