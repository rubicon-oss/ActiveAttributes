...
namespace ActiveAttributes.Annotations
{
  [AttributeUsage (AttributeTargets.Method | AttributeTargets.Event | AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
  public class IntroduceMemberAttribute : Attribute
  {
