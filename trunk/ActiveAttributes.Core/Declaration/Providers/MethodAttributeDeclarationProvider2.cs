...
namespace ActiveAttributes.Declaration.Providers
{
  public class MethodAttributeDeclarationProvider : IMethodLevelDeclarationProvider
  {
    ...
    public MethodAttributeDeclarationProvider (IMemberAttributeDeclarationProvider memberAttributeDeclarationProvider)
    {
    ...
    public IEnumerable<IAdviceBuilder> GetDeclarations (MethodInfo method)
    {
      ...
      return _memberAttributeDeclarationProvider.GetAdviceBuilders (method, methodSequence.Cast<MemberInfo>());
    }
  }
}