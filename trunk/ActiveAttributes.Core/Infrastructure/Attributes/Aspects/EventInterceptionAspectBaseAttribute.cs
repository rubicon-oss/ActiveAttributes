...
using System;
using ActiveAttributes.Core.Infrastructure.Attributes.Pointcuts;
...
namespace ActiveAttributes.Core.Infrastructure.Attributes.Aspects
{
  ...
  public abstract class EventInterceptionAspectBaseAttribute : InterceptionAspectBaseAttribute
  {
    [AspectDefinedPointcut]
    [MemberNamePointcut ("add_*")]
    public abstract void OnInterceptGet (IInvocation invocation);

    [AspectDefinedPointcut]
    [MemberNamePointcut ("remove_*")]
