...
{
  public class ParameterBasedDescriptorProvider : IMethodLevelDescriptorProvider
  {
    public IEnumerable<IDescriptor> GetDescriptors (MethodInfo method)
    {
      ...
      return distinctAspects.Select (x => new TypeDescriptor (x, Scope.Static, 0)).Cast<IDescriptor>();
    }
  }
}