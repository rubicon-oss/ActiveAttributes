...
namespace ActiveAttributes.Core.Assembly
{
  ...
  public interface IDescriptor
  {
    ...
    /// that the aspect is invoked earlier. The priority also overrides the <see cref="IConfiguration"/>.
    /// </summary>
    int Priority { get; }

    /// <summary>
    /// The <see cref="Core.Assembly.Configuration.Scope"/> (or lifetime) of the <see cref="AspectAttribute"/>.
    /// </summary>
    Scope Scope { get; }
