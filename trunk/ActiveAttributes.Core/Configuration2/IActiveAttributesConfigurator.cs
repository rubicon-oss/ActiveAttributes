...
namespace ActiveAttributes.Core.Configuration2
{
  ...
  {
    /// <summary>
    /// Configures the <see cref="IActiveAttributesConfiguration"/> object.
    /// </summary>
    /// <param name="activeAttributesConfiguration">The configuration.</param>
    void Initialize (IActiveAttributesConfiguration activeAttributesConfiguration);
  }
}