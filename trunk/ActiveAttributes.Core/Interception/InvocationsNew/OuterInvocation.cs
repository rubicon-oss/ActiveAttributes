...
namespace ActiveAttributes.Core.Interception.InvocationsNew
{
  public class OuterInvocation : IInvocation
  {
    ...
    private readonly Action<IInvocation> _innerMethod;

    public OuterInvocation (IInvocationContext context, IInvocation innerInvocation, Action<IInvocation> innerMethod)
    {
      _context = context;
